		...
		while (menu) {
			...
			if (choice < 1 || choice > 6) {
				...
				case 2:
					...
					//This case shows the user the contents of the cart and ask which one they would like to remove
				case 3:
				...
				case 4:
					...
					break;
					//This case gives the user the option to empty the cart, or leave the cart unchanged
				case 5:
					System.out.println("\n" + "Are you sure you want to Empty your Cart?");
					System.out.println("\n" + "Enter the number 1 to Empty your cart");
					System.out.println("Enter any other number to return to the previous screen");
					choice = scan.nextInt();
					//If Statement that flushes the cart if user enters a 1, any other number returns to previous menu
					if (choice == 1) {
